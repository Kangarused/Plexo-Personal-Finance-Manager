    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle(SiteScripts)
                ...
                .IncludeDirectory("~/App/controllers/accounts", "*.js")
                .IncludeDirectory("~/App/controllers/budgets", "*.js")
                .IncludeDirectory("~/App/controllers/bills", "*.js")
                .IncludeDirectory("~/App/controllers/households", "*.js")
